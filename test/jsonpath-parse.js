...
suite('jsonpath#parse-negative', function() {
  ...
  test('x - parse path with leading member component throws', function() {
    var path = jp.parse('.store');
    assert.deepEqual(path, [
      {
        "expression": {
  ...
  test('x - parse path with leading descendant member throws', function() {
    var path = jp.parse('..store');
    assert.deepEqual(path, [
      {
        "expression": {
