...
//     [ 'END', '' ] ],
    ...
    SUBSCRIPT_EXPRESSION_NESTABLE: [
      ...
      [ 'MEMBER_COMPONENT NESTED_PATH_COMPONENTS', '$$ = yy.ast.rollIntoParent($1, yy.ast.stashPop()); yy.ast.pop()' ],
      [ 'SUBSCRIPT_COMPONENT', '$$ = yy.ast.rollIntoParent({ expression: { type: "active_position", value: "{index}" } }, [ yy.ast.merge($1, { operation: "subscript" }) ]); yy.ast.pop()' ] //subscript component didn't start a branch-stash and doesn't make it up to path component or nested path component to receive the operation = "subscript" tag
    ],

    NESTED_PATH_COMPONENTS: [
      ['NESTED_PATH_COMPONENT', 'yy.ast.stash($1); $$ = yy.ast.stashClone();'], // $1 is already an array
