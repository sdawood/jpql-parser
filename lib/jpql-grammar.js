...
var grammar = {
  ...
  lex: {
    ...
    macros: {
      ...
      CallExpressionToken: "\\({Identifier}\\:\s*(.+?)\s*\\)(?=[\\[\\]\\,\\{\\}\\.]|$)", //no spaces allowed between the opening "(" and the key, also for good style no spaces are allowed between key and ":"
...
//     [ 'END', '' ] ],
    ...
    SUBSCRIPT_EXPRESSION_NESTABLE: [
      ...
      [ 'SUBSCRIPT_COMPONENT', '$$ = yy.ast.rollIntoParent(yy.ast.active_position(), [ yy.ast.merge($1, { operation: "subscript" }) ]); yy.ast.pop()' ], // subscript didn't start a branch
