...
//     [ 'END', '' ] ],
    ...
    SUBSCRIPT_EXPRESSION_NESTABLE: [
      ...
      [ 'DESCENDANT_MEMBER_COMPONENT NESTED_PATH_COMPONENTS', '$$ = yy.ast.rollIntoParent(yy.ast.merge($1, { scope: "descendant" }), yy.ast.stashPop()); yy.ast.pop()' ],
      ...
      [ 'CHILD_MEMBER_COMPONENT NESTED_PATH_COMPONENTS', '$$ = yy.ast.rollIntoParent({ expression: { type: "active_position", value: "{index}" } }, [ yy.ast.merge($1, { scope: "member" }) ].concat(yy.ast.stashPop())); yy.ast.pop()' ],
      ...
      [ 'CHILD_MEMBER_COMPONENT', '$$ = yy.ast.rollIntoParent({ expression: { type: "active_position", value: "{index}" } }, [ yy.ast.merge($1, { scope: "member" }) ]); yy.ast.pop()' ] //child member didn't start a branch
    ],
