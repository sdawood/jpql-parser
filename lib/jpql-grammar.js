...
//      [jpql_macros.identifier, "return 'IDENTIFIER_NAME'"],
  ...
  bnf: {
    ...
    /** Currently nested components don't make it all the way up to here */
    SUBSCRIPT_COMPONENT: [
...
//     [ 'END', '' ] ],
     ...
     * | SUBSCRIPT_COMPONENT
     * */
      [ 'NESTED_PATH_COMPONENTS', '$$ = yy.ast.rollIntoParent({ expression: { type: "active_position", value: "{index}" } }, yy.ast.stashPop()); yy.ast.pop()' ] ],
    ...
    SUBSCRIPT_EXPRESSION_NESTABLE_LEADING_MEMBER_EXPRESSION: [
      [ 'SUBSCRIPT_SIMPLE_EXPRESSION_LISTABLE', '$$ = $1'],
      [ 'SUBSCRIPT_ACTIVE_EXPRESSION_LISTABLE', '$$ = $1']
//      /**hoping to resolve the rule conflicts between distinguishing nestabl's leading from a listable*/
//      [ 'INTEGER',           '$$ = { expression: { type: "numeric_literal", value: parseInt($1) } }; yy.ast.set($$)' ],
//      [ 'STRING_LITERAL',    ' $$ = { expression: { type: "string_literal", value: $1 } }; yy.ast.set($$)' ],
//      [ 'IDENTIFIER',   '$$ = $1' ],
