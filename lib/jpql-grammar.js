...
var grammar = {
  ...
  lex: {
    ...
    macros: {
      ...
      ActiveScriptExpressionToken: "\\((({Take})?([~=\\+\\-\\*]|=>)?)?(\\{.+?\\})\\)",
...
//      [jpql_macros.identifier, "return 'IDENTIFIER_NAME'"],
      ...
      ["\\({ActiveScriptExpressionComponentToken}(\\:({ActiveScriptExpressionComponentToken}))?\\)(?=[\\:\\[\\]\\,\\{\\}\\.]|$)", "yytext = yy.lexer.matches; return 'ACTIVE_SCRIPT_EXPRESSION_TOKEN'"],
