...
//      [jpql_macros.identifier, "return 'IDENTIFIER_NAME'"],
      ...
      ["{ActiveScriptExpressionToken}(\\:{ActiveScriptExpressionToken})?", "yytext = yy.lexer.matches; return 'ACTIVE_SCRIPT_EXPRESSION_TOKEN'"],
...
//     [ 'END', '' ] ],
    ...
    [ 'ACTIVE_SCRIPT_EXPRESSION_TOKEN',       '$$ = { expression: { type: "script_expression|active", value: {map: $1 } } }; yy.ast.node($$)' ],
    ],
